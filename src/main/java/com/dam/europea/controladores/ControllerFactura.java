...
public class ControllerFactura implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle arg1) {
        ...
        botonAgregar.setOnAction(arg0 -> {
            try {
                ...
                // Incrementamos el último ID en uno y lo asignamos al nuevo TicketProducto
                if (lastId != null) {
                    ticketProducto.setId(lastId + 1);
                } else {
                    // Si no hay TicketProductos existentes, empezamos con el ID 1
    ...
    private void desasociarTicket(ActionEvent event) {
        ...
        alert.showAndWait().ifPresent(response -> {
            if (response == ButtonType.OK) {
                // Si el usuario confirma, procedemos con la desasociación

                // Obtenemos todas las entradas de TicketProducto asociadas a la factura
                ...
                // Actualizamos cada TicketProducto para establecer numeroFactura en null
    ...
    // Manejar la desasociación de un cliente
    ...
    // Poblar campos desde el producto seleccionado
    ...
    // Abrir diálogo de selección de producto
    ...
    // Actualizar el precio total de la factura
    ...
    // Cargar imágenes en los botones
    ...
    // Abrir el diálogo de selección de cliente
    ...
    // Abrir el diálogo de selección de ticket
    ...
    // Establecer detalles del cliente
